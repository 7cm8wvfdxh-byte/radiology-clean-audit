...
export default function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggle}
      className="p-2 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-all border border-transparent hover:border-zinc-200 dark:hover:border-zinc-700"
      aria-label={dark ? "Acik temaya gec" : "Koyu temaya gec"}
      title={dark ? "Acik tema" : "Koyu tema"}
    >
      {dark ? (
